...
class GetHandler
{
    ...
    public function getVal()
    {
        ...
        $sql = $this->pdo->query("SELECT sum(valor_registro) FROM registros where data_registro between '2020-01-01' and '$anoAtual-$mesAnterior-31' and tipo_registro = 'deposito'");
        $saldo3 = $sql->fetch();

        $sql = $this->pdo->query("SELECT sum(valor_registro) FROM registros where data_registro between '2020-01-01' and '$anoAtual-$mesAnterior-31' and tipo_registro = 'despesa'");
        $saldo2 = $sql->fetch();

        $sql = $this->pdo->query("SELECT sum(valor_registro) FROM registros where data_registro between '2020-01-01' and '$anoAtual-$mesAnterior-31' and tipo_registro != 'despesa' and tipo_registro != 'deposito'");
        $saldo1 = $sql->fetch();
        ...
        $sql = $this->pdo->query("SELECT sum(valor_registro) FROM registros where data_registro between '$anoAtual-$mesAtual-01' and '$dataAtual' and tipo_registro != 'despesa' AND tipo_registro != 'deposito'");
        $receitas = $sql->fetch();
        ...
        $sql = $this->pdo->query("SELECT sum(valor_registro) FROM registros where data_registro between '$anoAtual-$mesAtual-01' and '$anoAtual-$mesAtual-31' and tipo_registro = 'despesa'");
        $despesas = $sql->fetch();
